...
public class PullToRefreshListView extends ListView {
	...
	private void init() {
		...
		header = (RelativeLayout) headerContainer.findViewById(R.id.refresh_header);
		text = (TextView) header.findViewById(R.id.refresh_text);
		image = (ImageView) header.findViewById(R.id.refresh_image);
		spinner = (ProgressBar) header.findViewById(R.id.refresh_spinner);
